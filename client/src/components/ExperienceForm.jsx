...
const ExperienceForm = ({ data, onChange}) =>{
    ...
    const generateDescription = async (index) => {
        ...
        const prompt = `enhance this job description for my resume : ${experience.description} for the
        ...
        <div className="space-y-6">
            ...
            {data.length === 0 ? (
                ...
                <label className="flex items-center gap-2">
                  ...
                  "is_current",e.target.checked ? true: false  )}} className="rounded border-gray-300 
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        {generatingIndex === index || !experience.position || !experience.company || !experience.description}
                    ...
                    updateExperience(index,"description",e.target.value)} rows={4} 
                    className="w-full text-sm px-3 py-2 rounded-lg resize-none" placeholder="

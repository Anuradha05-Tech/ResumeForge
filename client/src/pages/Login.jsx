import { MailIcon, User2Icon, LockIcon } from "lucide-react";
...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen  bg-gradient-to-b from-[#983de7] to-[#83137f] ">
